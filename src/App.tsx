            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  <div className="text-[8px] font-black uppercase tracking-[0.28em] text-white/38">
                    {matchCard.label} • {day.format}
                  </div>

                  <div className="mt-2 space-y-[2px]">
                    <div className="truncate text-[14px] font-black uppercase tracking-[0.06em] text-red-100/90">
                      {matchCard.redNames}
                    </div>

                    <div className="truncate text-[14px] font-black uppercase tracking-[0.06em] text-blue-100/90">
                      {matchCard.blueNames}
                    </div>
                  </div>
                </div>
                ...
                <div className="shrink-0 text-right">
                  ...
                  <div className="mt-1 text-[9px] font-bold uppercase tracking-[0.18em] text-white/42">
              ...
              <div className="mt-3 flex items-center justify-between border-t border-white/8 pt-2">
                ...
                <span className="ml-3 shrink-0 text-[10px] font-black uppercase tracking-[0.16em] text-[#d1c79f]">
                  {matchCard.sub}
                </span>
              </div>
            </button>
