...
export default function PlayerCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-[64px_minmax(0,1fr)_74px] items-center gap-3">
        <label className="group relative flex h-16 w-16 cursor-pointer items-center justify-center overflow-hidden rounded-full border border-white/15 bg-black/45 shadow-[0_12px_26px_rgba(0,0,0,0.45)]">
          {player.photo ? (
            ...
            <div className="flex h-full w-full flex-col items-center justify-center px-1 text-center">
              <div className="text-[22px] leading-none text-white/80">+</div>
              <div className="mt-0.5 text-[5px] font-black uppercase leading-[1.08] tracking-[0.07em] text-white/45">
                Tap to
                <br />
                add photo
              </div>
        ...
        <div className="min-w-0">
          <div className="mb-1 text-[7px] font-black uppercase tracking-[0.22em] text-white/32">
            Player {index + 1}
          </div>
          ...
          <input
            ...
            className={cx(
              "w-full border-0 bg-transparent p-0 text-[24px] font-black leading-none tracking-[-0.04em] text-white outline-none placeholder:text-white/25",
        ...
        <div className="flex flex-col items-end gap-2">
          <div className="w-[74px] rounded-[18px] border border-white/14 bg-black/36 px-2 py-2 text-center">
            <div className="text-[6px] font-black uppercase tracking-[0.16em] text-white/42">
              GWR
            </div>
